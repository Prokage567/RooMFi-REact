            ...
            <div className='flex min-h-screen flex-col overflow-auto'>
                <nav>
                    <div className='bg-[url(src/assets/images/head.svg)] bg-cover bg-no-repeat shadow-[0_7px_5px_rgba(0,0,0,0.25)]'>
                        <div className="md:[200px] flex flex-row pl-[25px] p-3">
                            <img src={logo} className='w-[85px] md:w-[75px] lg:w-[65px]' />
                            <div className='font-[KronaOne] text-orange-500 md:text-[50px]/[34.8px] lg:text-[40px]/[31.8px] text-[55px]/[39.8px] pl-[15px]'>
                                <br />
                                RooMFI
                            </div>
                        </div>
