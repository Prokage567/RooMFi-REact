...
function Homepage() {
    return (
        <>
        {/* ignore this yet */}
            <div className="flex flex-col items-center overflow-y-auto no-scrollbar max-h-[90vh] scale-[0.1] origin-(0*100, 0*100)">
                <div className='pl-[365px] pr-[365px] flex sticky top-9 justify-center '>
                ...
                <div className='flex pt-[50px] flew-wrap flex-row gap-2 justify-between w-[80vw] pb-12 pl-[100px] pr-[50px]'>
                    <div className='pt-[40px]'>
                        ...
                        <h4 className='font-[KronaOne] text-[40px] pt-6'>
                            RooMFI
                        </h4><p className='font-[NiramitReg] text-[23px] pr-1 text-balance break-normal'>
                    ...
                    <div>
                        <img src={img} alt="" width='1500px' className='mt-[20px]' />
                    </div>
                </div>
                <div className='flex flex-col'>
                    <img src={img2} alt=""  className='pt-[7vh] -z-10'  />
                    <div className='pl-[650px] relative -z-10 -top-[450px] -mb-[450px]'>
                        <div className='h-[550px] w-[470px] bg-cyan-500 text-zinc-100 p-12'>
