    ...
    (
      <DayPicker
        ...
        classNames={{
          ...
          caption_label: "indent-16 text-[#242F5B] text-[25px] font-bold",
          nav: "space-x-1 flex",
          nav_button: cn(
          ...
          nav_button_next: "absolute top-1 left-[28.5vw]",
          table: "w-full border-collapse space-y-1",
          head_row: "flex",
          head_cell:
            " rounded-md w-[70px] sm:w-[80px] md:w-[40px] lg:w-[50px] text-[#242F5B] text-[18px] ",
          row: "flex  w-full",
          cell: cn(
